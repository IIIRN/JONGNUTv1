    ...
    <main className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-xl shadow-lg">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold text-slate-800">///RN-STUDIO</h1>
          <p className="text-gray-500">ระบบจองบริการ</p>
        </div>

        {/* Customer & Beautician Section */}
        <div className="p-6 border rounded-lg bg-gray-50">
          <h2 className="text-xl font-semibold text-center text-gray-700 mb-4">สำหรับลูกค้าและช่าง</h2>
          <button 
            onClick={() => router.push('/dashboard')} // Changed this line
            className="w-full flex items-center justify-center py-3 px-4 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-400 transition-colors"
          >
